...
export class MyAccountOZstd extends Account {
    // alternatively replace the constructor with a static initialize method if you need async code

    static readonly MYACCOUNTPATH = "starknet-artifacts/contracts/openzeppelin/account/presets/Account_0_5_1.cairo";
    ...
    protected getMessageHash(
        ...
        return MyAccountOZstd.standardGetMessageHash(
            transactionHashPrefix,
            accountAddress,
            callArray,
            nonce,
    ...
    protected getSignatures(messageHash: string): bigint[] {
        ...
        return MyAccountOZstd.standardGetSignatures(this.publicKey, this.keyPair, messageHash);
    }
