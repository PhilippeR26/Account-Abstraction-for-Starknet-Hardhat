...
export class MyAccountSimple extends Account {
    ...
    protected getMessageHash(
        ...
        return MyAccountSimple.standardGetMessageHash(
            transactionHashPrefix,
            accountAddress,
            callArray,
            nonce,
    ...
    protected getSignatures(messageHash: string): bigint[] {
        ...
        return MyAccountSimple.standardGetSignatures(this.publicKey, this.keyPair, messageHash);
    }
